defmodule AmmoniaDesk.ProductGroup do
  @moduledoc """
  ...
  Create a module that implements the `AmmoniaDesk.ProductGroup.Frame` behaviour
  and register it in the `@registry` below.
  """

  alias AmmoniaDesk.ProductGroup.Frames
