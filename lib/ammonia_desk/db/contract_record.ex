defmodule AmmoniaDesk.DB.ContractRecord do
  @moduledoc """
  ...
  schema "contracts" do
    ...
    # Relationship
    has_many :solve_links, AmmoniaDesk.DB.SolveAuditContract, foreign_key: :contract_id
  ...
  def from_contract(%AmmoniaDesk.Contracts.Contract{} = c) do
    %{
      id: c.id,
