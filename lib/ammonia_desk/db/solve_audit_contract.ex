defmodule AmmoniaDesk.DB.SolveAuditContract do
  @moduledoc """
  ...
  schema "solve_audit_contracts" do
    belongs_to :solve_audit, AmmoniaDesk.DB.SolveAuditRecord, type: :string
    belongs_to :contract, AmmoniaDesk.DB.ContractRecord, type: :string
