defmodule AmmoniaDesk.DB.SolveAuditRecord do
  @moduledoc """
  ...
  schema "solve_audits" do
    ...
    # Relationships
    has_many :contract_links, AmmoniaDesk.DB.SolveAuditContract, foreign_key: :solve_audit_id
  ...
  def from_solve_audit(%AmmoniaDesk.Solver.SolveAudit{} = a) do
    %{
      id: a.id,
