defmodule AmmoniaDesk.Chain.AutoSolveCommitter do
  @moduledoc """
  ...
  alias AmmoniaDesk.Chain.Payload
  alias AmmoniaDesk.DB.ChainCommitRecord
  ...
  def commit(opts) do
    ...
    record_attrs = %{
      ...
      result_status: to_string(distribution[:signal] || :unknown),
  ...
  defp serialize_variable_sources do
    try do
      AmmoniaDesk.Data.LiveState.last_updated()
